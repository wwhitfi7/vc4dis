typedef enum {
    ...
    mov_pd_ra = 0xCC00,
    mov_rd_pd = 0xCC20,
    mem_mask_48b_full = 0xFFFF,
    jump_immed48 = 0xE000,
    branch_offset48 = 0xE100,
    jump_long_immed48 = 0xE200,
    branch_long_offset48 = 0xE300,
    mem_mask_48b_add = 0xFFE0,
    add_reg_pc_offset48 = 0xE500,
    mem_mask_48b_ldst = 0xFF20,
    ld_reg_offset48 = 0xE600,
    st_reg_offset48 = 0xE620,
    ld_reg_pc_offset48 = 0xE700,
    st_reg_pc_offset48 = 0xE720,
    arithlog_mask_48b = 0xFC00,
    arithlog_op_48b = 0xE800,
    arithlog_add_48b = 0xEC00,
} instruction_type;
